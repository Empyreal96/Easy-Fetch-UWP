...
#pragma warning disable 1998
        public async Task<Certificate> GetRootDeviceCertificateAsync(bool acceptUntrustedCerts = false)
        {
            ...
            if (acceptUntrustedCerts)
            {
                ...
                /*requestSettings.IgnorableServerCertificateErrors.Add(ChainValidationResult.InvalidSignature);
                requestSettings.IgnorableServerCertificateErrors.Add(ChainValidationResult.InvalidName);
                requestSettings.IgnorableServerCertificateErrors.Add(ChainValidationResult.InvalidCertificateAuthorityPolicy);
                requestSettings.IgnorableServerCertificateErrors.Add(ChainValidationResult.OtherErrors);*/
            }
...
#pragma warning restore 1998
        ...
        public void SetManualCertificate(Certificate cert)
        {
